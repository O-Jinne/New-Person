...
const MASTER_EXERCISES = [
  { category: "가슴", name: "바벨 벤치프레스", note: "가슴 전체, 가장 기본이 되는 대운동" },
  { category: "가슴", name: "덤벨 인클라인 프레스", note: "상부 가슴 집중" },
  { category: "가슴", name: "덤벨 디클라인 프레스", note: "하부 가슴 집중" },
  { category: "가슴", name: "머신 체스트 프레스", note: "안정적인 자세, 초보자 친화적" },
  { category: "가슴", name: "머신 플라이", note: "가슴 고립, 스트레치 자극" },
  { category: "가슴", name: "덤벨 플라이", note: "가슴 고립, 스트레치 자극" },
  { category: "가슴", name: "케이블 크로스오버", note: "가슴 안쪽(내측) 모아주는 느낌" },
  { category: "가슴", name: "딥스", note: "가슴 하부+삼두 복합 자극" },
  { category: "가슴", name: "덤벨 클로즈그립 프레스", note: "가슴+삼두 동시 자극" },
  { category: "등", name: "랫풀다운", note: "등 넓이(광배근), 초보자 친화적" },
  { category: "등", name: "바벨 벤트오버 로우", note: "등 두께, 척추기립근도 관여" },
  { category: "등", name: "덤벨 원암 로우", note: "좌우 따로, 벤치 지지라 허리 부담 적음" },
  { category: "등", name: "케이블 시티드 로우", note: "등 두께, 허리 고정된 채 당김" },
  { category: "등", name: "풀업", note: "등 넓이, 체중 이용 고난도" },
  { category: "등", name: "티바 로우", note: "등 두께 집중" },
  { category: "어깨", name: "덤벨 숄더 프레스", note: "어깨 전체, 기본 대운동" },
  { category: "어깨", name: "바벨 밀리터리 프레스", note: "어깨 전체, 고중량 가능" },
  { category: "어깨", name: "사이드 레터럴 레이즈", note: "어깨 옆(측면) 라인 넓히기" },
  { category: "어깨", name: "프론트 레이즈", note: "어깨 앞(전면) 집중" },
  { category: "어깨", name: "리어 델트 플라이", note: "어깨 뒤(후면), 자세 교정에도 도움" },
  { category: "어깨", name: "페이스풀", note: "어깨 뒤+회전근개, 자세 보강" },
  { category: "어깨", name: "케이블 숄더 프레스", note: "어깨 전체, 케이블이라 자세 안정적" },
  { category: "팔", name: "바벨 컬", note: "이두 전체, 기본 컬 동작" },
  { category: "팔", name: "덤벨 컬", note: "이두 전체, 좌우 따로 조절 가능" },
  { category: "팔", name: "덤벨 해머컬", note: "이두+전완, 손목 중립 그립" },
  { category: "팔", name: "덤벨 컨센트레이션 컬", note: "이두 고립, 앉아서 집중 자극" },
  { category: "팔", name: "덤벨 컬 21s", note: "이두 마무리용, 펌프감 극대화" },
  { category: "팔", name: "케이블 푸시다운", note: "삼두 고립, 팔 두께 만들기 좋음" },
  { category: "팔", name: "덤벨 오버헤드 익스텐션", note: "삼두 장두(안쪽) 집중, 팔 두께에 중요" },
  { category: "팔", name: "스컬크러셔", note: "삼두 전체, 고중량 가능" },
  { category: "하체", name: "헥스바 데드리프트", note: "하체+등 복합, 허리 부담 적은 데드리프트" },
  { category: "하체", name: "바벨 데드리프트", note: "하체+등 복합, 후면사슬 전체" },
  { category: "하체", name: "레그프레스", note: "허벅지 앞(대퇴사두) 집중, 안전한 대운동" },
  { category: "하체", name: "바벨 스쿼트", note: "하체 전체, 기본 대운동" },
  { category: "하체", name: "덤벨 불가리안 스플릿 스쿼트", note: "허벅지+엉덩이, 좌우 따로" },
  ...
  { category: "하체", name: "케이블 킥백", note: "엉덩이 고립, 가벼운 무게로 자극" },
  { category: "코어", name: "플랭크", note: "복근 전체+코어 안정성, 등척성 운동" },
  { category: "코어", name: "행잉 레그레이즈", note: "하복부 집중, 철봉 필요" },
...
const BODYWEIGHT_MASTER_EXERCISES = [
  { category: "가슴", name: "푸시업", note: "가슴 전체, 기본 맨몸 운동" },
  { category: "가슴", name: "와이드 푸시업", note: "가슴 바깥쪽 넓게 자극" },
  { category: "가슴", name: "다이아몬드 푸시업", note: "가슴 안쪽+삼두 집중" },
  { category: "가슴", name: "디클라인 푸시업", note: "상부 가슴, 발을 높게 두고 진행" },
  { category: "가슴", name: "인클라인 푸시업", note: "하부 가슴, 손을 높게 두고 진행 (난이도 낮음)" },
  { category: "가슴", name: "벤치 딥스", note: "가슴 하부+삼두, 의자/벤치 필요" },
  { category: "등", name: "풀업", note: "등 넓이, 철봉 필요 (고난도)" },
  { category: "등", name: "친업", note: "등+이두, 철봉 필요 (풀업보다 쉬움)" },
  { category: "등", name: "인버티드 로우", note: "등 두께, 낮은 봉/테이블 필요" },
  { category: "등", name: "슈퍼맨", note: "등 하부+척추기립근, 바닥에 엎드려 진행" },
  { category: "등", name: "도어프레임 로우", note: "등 두께, 문틀 이용 (기구 없이 가능)" },
  { category: "어깨", name: "파이크 푸시업", note: "어깨 전체, 엉덩이 들고 진행" },
  { category: "어깨", name: "핸드스탠드 푸시업", note: "어깨 전체, 물구나무 자세 (고난도)" },
  { category: "어깨", name: "플랭크 숄더탭", note: "어깨+코어 안정성" },
  { category: "어깨", name: "파이크 홀드", note: "어깨 등척성 버티기" },
  { category: "팔", name: "딥스", note: "삼두+가슴 하부, 의자/봉 필요" },
  { category: "팔", name: "클로즈그립 푸시업", note: "삼두 집중, 손 간격 좁게" },
  { category: "팔", name: "타올 컬", note: "이두, 수건으로 저항 만들어 진행" },
  { category: "팔", name: "밴드 컬", note: "이두, 저항밴드 필요" },
  { category: "하체", name: "맨몸 스쿼트", note: "하체 전체, 기본 동작" },
  { category: "하체", name: "런지", note: "허벅지+엉덩이, 좌우 따로" },
  { category: "하체", name: "불가리안 스플릿 스쿼트", note: "허벅지+엉덩이, 뒷발 올리고 진행" },
  { category: "하체", name: "점프 스쿼트", note: "하체 폭발력+심폐" },
  { category: "하체", name: "피스톨 스쿼트", note: "한 다리 스쿼트 (고난도, 균형감 필요)" },
  { category: "하체", name: "글루트 브릿지", note: "엉덩이 집중, 바닥에 누워 진행" },
  { category: "하체", name: "카프레이즈", note: "종아리 집중" },
  { category: "코어", name: "플랭크", note: "복근+코어 안정성, 등척성 운동" },
  { category: "코어", name: "사이드 플랭크", note: "옆구리(복사근) 집중" },
  { category: "코어", name: "레그레이즈", note: "하복부 집중" },
  { category: "코어", name: "마운틴 클라이머", note: "복근+심폐, 동적인 코어 운동" },
  { category: "코어", name: "V업", note: "복근 전체, 상하체 동시에 접는 동작" },
...
function init() {
  ...
  document.getElementById("toggle-filter-btn").addEventListener("click", () => {
    showAllExercisesInModal = !showAllExercisesInModal;
    updateFilterToggleLabel();
    renderExerciseModalList(document.getElementById("exercise-search").value);
  });
...
function renderExercises() {
  ...
  currentExercises.forEach((ex, idx) => {
    ...
    nameSpan.textContent = `${idx + 1}. ${ex.name}${idx === 0 && !ex.custom ? " ⭐" : ""}`;
    ...
    if (isOpen) {
      ...
      if (idx === 0 && !ex.custom) {
        ...
        coreNote.className = "core-lift-note";
        coreNote.textContent = "⭐ 이 루틴의 대운동 · 고정";
        detail.appendChild(coreNote);
      } else {
...
function getRelevantCategories() {
  const dayCats = DAY_MUSCLE_CATEGORIES[currentDay] || [];
  return [...dayCats, "코어", "유산소"];
}

function openExerciseModal() {
  showAllExercisesInModal = false;
  updateFilterToggleLabel();
...
function updateFilterToggleLabel() {
  ...
  if (!btn) return;
  btn.textContent = showAllExercisesInModal
    ? "이 루틴에 맞는 운동만 보기"
    : "전체 운동 보기";
}
...
function renderExerciseModalList(query) {
  ...
  let filtered = getMasterList().filter(ex => ex.name.toLowerCase().includes(q));
  if (!showAllExercisesInModal) {
    filtered = filtered.filter(ex => relevantCats.includes(ex.category));
  }
  ...
  filtered.forEach(ex => {
    ...
    item.innerHTML = `
      ...
      ${ex.note ? `<div class="modal-item-note">${ex.note}</div>` : ""}
    `;
...
function renderHistory() {
  ...
  for (let i = 0; i < firstDayOfWeek; i++) {
    ...
    const dateKey = `${prevMonthYear}-${String(prevMonthIndex + 1).padStart(2, "0")}-${String(d).padStart(2, "0")}`;
    grid.appendChild(buildCalendarCell(dateKey, d, logs[dateKey], todayStr, true));
  }

  for (let d = 1; d <= daysInMonth; d++) {
    const dateKey = `${calYear}-${String(calMonth + 1).padStart(2, "0")}-${String(d).padStart(2, "0")}`;
    grid.appendChild(buildCalendarCell(dateKey, d, logs[dateKey], todayStr, false));
  }

  // ---- 다음 달 꼬리 (마지막 주를 채워서 그리드가 어중간하게 끝나지 않게) ----
  const totalSoFar = firstDayOfWeek + daysInMonth;
  ...
  for (let d = 1; d <= trailingCount; d++) {
    const dateKey = `${nextMonthYear}-${String(nextMonthIndex + 1).padStart(2, "0")}-${String(d).padStart(2, "0")}`;
    grid.appendChild(buildCalendarCell(dateKey, d, logs[dateKey], todayStr, true));
  }
...
// ===== 캘린더 셀 하나 생성 (isOtherMonth=true면 전월/익월 날짜, 옅게 표시) =====
function buildCalendarCell(dateKey, dayNum, entry, todayStr, isOtherMonth) {
